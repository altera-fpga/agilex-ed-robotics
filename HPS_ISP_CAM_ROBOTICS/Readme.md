# Robotics Camera (ISP) with Hard Processor System - Hardware Repository (**HW**).
<br>

## Overview

This repository contains the necessary files and collateral to build and create a Quartus Prime Project variant of the
Robotics Camera with an HPS instance for higher-level robot manipulation control.
...
You can select any other available XML targeting other boards from the `HPS_ISP_CAM_ROBOTICS` directory.
...
quartus_sh -t ./modular_design_toolkit/scripts/create/create_shell.tcl \
   -xml_path ./HPS_ISP_CAM_ROBOTICS/AGX_5E_Modular_Devkit_HPS_ISP_CAM_ROB.xml \
   -proj_path <project> -o
```
