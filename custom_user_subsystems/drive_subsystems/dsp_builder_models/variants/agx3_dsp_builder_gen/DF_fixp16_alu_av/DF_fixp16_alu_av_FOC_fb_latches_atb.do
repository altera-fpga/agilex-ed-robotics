...
if {! [file exists $base_dir/DF_fixp16_alu_av_FOC_fb_latches]} {
    file delete -force $base_dir/DF_fixp16_alu_av_FOC_fb_latches
}

project new $base_dir DF_fixp16_alu_av_FOC_fb_latches
...
do "$base_dir/DF_fixp16_alu_av/DF_fixp16_alu_av_FOC_fb_latches_fpc.do"
...
puts {vcom -quiet -O0 $base_dir/DF_fixp16_alu_av/DF_fixp16_alu_av_FOC_fb_latches_atb.vhd}
project addfile $base_dir/DF_fixp16_alu_av/DF_fixp16_alu_av_FOC_fb_latches_atb.vhd vhdl
project addfile $base_dir/DF_fixp16_alu_av/DF_fixp16_alu_av_FOC_fb_latches_stm.vhd vhdl
...
if {$vcomfailed == 0} {
    onbreak {
        ...
        if {$regOK == 1} {
            ...
            if { [catch {exa mismatch_out_2_iq_int_latch_tpl} mismatch] == 0 && $mismatch } {
                report_mismatch out_2_iq_int_latch_tpl $cyclenum
            }
            if { [catch {exa mismatch_out_1_id_int_latch_tpl} mismatch] == 0 && $mismatch } {
                report_mismatch out_1_id_int_latch_tpl $cyclenum
            }
        } else {
    ...
    eval vsim -quiet -suppress 14408 -error 3473 -msgmode both -voptargs="+acc" -t ps DF_fixp16_alu_av_FOC_fb_latches_atb $ll
    do $base_dir/DF_fixp16_alu_av/DF_fixp16_alu_av_FOC_fb_latches_atb.wav.do
