...
set_module_property NAME altera_rob_aruco
set_module_property DISPLAY_NAME "ArUco generator Altera FPGA IP"
...
set_parameter_property  ARUCO_ID                  HDL_PARAMETER             false
...
add_display_item  "Video data format"   ARUCO_ID                       parameter
...
proc composition_cb {} {
   ...
   set v_reset_sync_vvp_version     "24.5.0"
   set v_output_bridge_vvp_version  "24.5.0"
   set v_clk_brdg_version           "19.2.0"

   set v_bps              [get_parameter_value BPS]
   set v_num_colours      3
   set v_pip              [get_parameter_value PIXELS_IN_PARALLEL]
   set v_aruco_id         [get_parameter_value ARUCO_ID]
   ...
   add_instance   scheduler            altera_rob_aruco_scheduler            99.0
   add_instance   core                 altera_rob_aruco_algo_comp            99.0
   ...
   set_instance_parameter_value  core        ARUCO_ID                         ${v_aruco_id}
