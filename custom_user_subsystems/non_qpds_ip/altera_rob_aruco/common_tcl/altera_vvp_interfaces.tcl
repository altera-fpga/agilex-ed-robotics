...
set altera_vvp_protocols_file [file join ${common_tcl_dir} "altera_vvp_protocols.tcl"]
source ${altera_vvp_protocols_file}
package require intel_vvp_st_format 1.0
package require intel_vvp_mm_format 1.0

set altera_vvp_generic_interfaces_file [file join ${common_tcl_dir} "altera_vvp_generic_interfaces.tcl"]
source $altera_vvp_generic_interfaces_file
