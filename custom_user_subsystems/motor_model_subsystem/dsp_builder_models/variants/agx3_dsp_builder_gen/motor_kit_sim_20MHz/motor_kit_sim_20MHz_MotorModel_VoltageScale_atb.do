...
if {! [file exists $base_dir/motor_kit_sim_20MHz_MotorModel_VoltageScale]} {
    file delete -force $base_dir/motor_kit_sim_20MHz_MotorModel_VoltageScale
}

project new $base_dir motor_kit_sim_20MHz_MotorModel_VoltageScale
...
do "$base_dir/motor_kit_sim_20MHz/motor_kit_sim_20MHz_MotorModel_VoltageScale_fpc.do"
...
puts {vcom -quiet -O0 $base_dir/motor_kit_sim_20MHz/motor_kit_sim_20MHz_MotorModel_VoltageScale_atb.vhd}
project addfile $base_dir/motor_kit_sim_20MHz/motor_kit_sim_20MHz_MotorModel_VoltageScale_atb.vhd vhdl
project addfile $base_dir/motor_kit_sim_20MHz/motor_kit_sim_20MHz_MotorModel_VoltageScale_stm.vhd vhdl
...
if {$vcomfailed == 0} {
    onbreak {
        ...
        if {$regOK == 1} {
            ...
            if { [catch {exa mismatch_out_1_FractionA_ND_ufix16_En16_x_tpl} mismatch] == 0 && $mismatch } {
                report_mismatch out_1_FractionA_ND_ufix16_En16_x_tpl $cyclenum
            }
            if { [catch {exa mismatch_out_3_FractionC_ND_ufix16_En16_tpl} mismatch] == 0 && $mismatch } {
                report_mismatch out_3_FractionC_ND_ufix16_En16_tpl $cyclenum
            }
            if { [catch {exa mismatch_out_2_FractionB_ND_ufix16_En16_tpl} mismatch] == 0 && $mismatch } {
                report_mismatch out_2_FractionB_ND_ufix16_En16_tpl $cyclenum
            }
        } else {
    ...
    eval vsim -quiet -suppress 14408 -error 3473 -msgmode both -voptargs="+acc" -t ps motor_kit_sim_20MHz_MotorModel_VoltageScale_atb $ll
    do $base_dir/motor_kit_sim_20MHz/motor_kit_sim_20MHz_MotorModel_VoltageScale_atb.wav.do
