...
entity motor_kit_sim_20MHz_MotorModel_VoltageScale_atb is
end;

architecture normal of motor_kit_sim_20MHz_MotorModel_VoltageScale_atb is
...
component motor_kit_sim_20MHz_MotorModel_VoltageScale_stm is
    port (
...
signal in_2_VoltageA_sfix16_En6_tpl_stm : STD_LOGIC_VECTOR (15 downto 0);
signal in_4_VoltageC_sfix16_En6_tpl_stm : STD_LOGIC_VECTOR (15 downto 0);
signal in_3_VoltageB_sfix16_En6_tpl_stm : STD_LOGIC_VECTOR (15 downto 0);
...
signal in_2_VoltageA_sfix16_En6_tpl_dut : STD_LOGIC_VECTOR (15 downto 0);
signal in_4_VoltageC_sfix16_En6_tpl_dut : STD_LOGIC_VECTOR (15 downto 0);
signal in_3_VoltageB_sfix16_En6_tpl_dut : STD_LOGIC_VECTOR (15 downto 0);
...
-- General Purpose data in real output
checkGPIn1 : process (clk, areset, in_2_VoltageA_sfix16_En6_tpl_dut, in_2_VoltageA_sfix16_En6_tpl_stm)
begin
END PROCESS;


-- General Purpose data in real output
checkGPIn3 : process (clk, areset, in_4_VoltageC_sfix16_En6_tpl_dut, in_4_VoltageC_sfix16_En6_tpl_stm)
begin
END PROCESS;


-- General Purpose data in real output
checkGPIn5 : process (clk, areset, in_3_VoltageB_sfix16_En6_tpl_dut, in_3_VoltageB_sfix16_En6_tpl_stm)
begin
END PROCESS;
...
dut : motor_kit_sim_20MHz_MotorModel_VoltageScale port map (
    in_1_Voltage_range_int16_tpl_stm,
    in_2_VoltageA_sfix16_En6_tpl_stm,
    in_4_VoltageC_sfix16_En6_tpl_stm,
    in_3_VoltageB_sfix16_En6_tpl_stm,
...
sim : motor_kit_sim_20MHz_MotorModel_VoltageScale_stm port map (
    in_1_Voltage_range_int16_tpl_stm,
    in_2_VoltageA_sfix16_En6_tpl_stm,
    in_4_VoltageC_sfix16_En6_tpl_stm,
    in_3_VoltageB_sfix16_En6_tpl_stm,
