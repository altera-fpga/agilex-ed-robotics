...
if {! [file exists $base_dir/motor_kit_sim_20MHz_MotorModel_Fraction_to_Pulse6]} {
    file delete -force $base_dir/motor_kit_sim_20MHz_MotorModel_Fraction_to_Pulse6
}

project new $base_dir motor_kit_sim_20MHz_MotorModel_Fraction_to_Pulse6
...
do "$base_dir/motor_kit_sim_20MHz/motor_kit_sim_20MHz_MotorModel_Fraction_to_Pulse6_fpc.do"
...
puts {vcom -quiet -O0 $base_dir/motor_kit_sim_20MHz/motor_kit_sim_20MHz_MotorModel_Fraction_to_Pulse6_atb.vhd}
project addfile $base_dir/motor_kit_sim_20MHz/motor_kit_sim_20MHz_MotorModel_Fraction_to_Pulse6_atb.vhd vhdl
project addfile $base_dir/motor_kit_sim_20MHz/motor_kit_sim_20MHz_MotorModel_Fraction_to_Pulse6_stm.vhd vhdl
...
if {$vcomfailed == 0} {
    ...
    eval vsim -quiet -suppress 14408 -error 3473 -msgmode both -voptargs="+acc" -t ps motor_kit_sim_20MHz_MotorModel_Fraction_to_Pulse6_atb $ll
    do $base_dir/motor_kit_sim_20MHz/motor_kit_sim_20MHz_MotorModel_Fraction_to_Pulse6_atb.wav.do
