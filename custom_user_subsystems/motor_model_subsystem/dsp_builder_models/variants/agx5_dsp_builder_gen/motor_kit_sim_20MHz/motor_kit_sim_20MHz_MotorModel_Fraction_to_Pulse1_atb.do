...
if {! [file exists $base_dir/motor_kit_sim_20MHz_MotorModel_Fraction_to_Pulse1]} {
    file delete -force $base_dir/motor_kit_sim_20MHz_MotorModel_Fraction_to_Pulse1
}

project new $base_dir motor_kit_sim_20MHz_MotorModel_Fraction_to_Pulse1
...
do "$base_dir/motor_kit_sim_20MHz/motor_kit_sim_20MHz_MotorModel_Fraction_to_Pulse1_fpc.do"
...
puts {vcom -quiet -O0 $base_dir/motor_kit_sim_20MHz/motor_kit_sim_20MHz_MotorModel_Fraction_to_Pulse1_atb.vhd}
project addfile $base_dir/motor_kit_sim_20MHz/motor_kit_sim_20MHz_MotorModel_Fraction_to_Pulse1_atb.vhd vhdl
project addfile $base_dir/motor_kit_sim_20MHz/motor_kit_sim_20MHz_MotorModel_Fraction_to_Pulse1_stm.vhd vhdl
...
if {$vcomfailed == 0} {
    onbreak {
        ...
        if {$regOK == 1} {
            ...
            if { [catch {exa mismatch_out_1_PulseDensity_Bool_x_tpl} mismatch] == 0 && $mismatch } {
                report_mismatch out_1_PulseDensity_Bool_x_tpl $cyclenum
            }
        } else {
    ...
    eval vsim -quiet -suppress 14408 -error 3473 -msgmode both -voptargs="+acc" -t ps motor_kit_sim_20MHz_MotorModel_Fraction_to_Pulse1_atb $ll
    do $base_dir/motor_kit_sim_20MHz/motor_kit_sim_20MHz_MotorModel_Fraction_to_Pulse1_atb.wav.do
