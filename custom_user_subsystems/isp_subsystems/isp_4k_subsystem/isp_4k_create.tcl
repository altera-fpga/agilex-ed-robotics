...
proc create_isp_subsystem {} {
    ...
    # isp_ccm
    add_interface           isp_lite_out_m_vid  axi4stream  manager
    set_interface_property  isp_lite_out_m_vid  EXPORT_OF   isp_ccm.axi4s_vid_out

    ### Assign Base Addresses ###

    set_connection_parameter_value isp_mm_bridge.m0/isp_blc.av_mm_control_agent                 baseAddress "0x00000600"
    set_connection_parameter_value isp_mm_bridge.m0/isp_wbc.av_mm_control_agent                 baseAddress "0x00000400"
    set_connection_parameter_value isp_mm_bridge.m0/isp_dms.av_mm_control_agent                 baseAddress "0x00000200"
    set_connection_parameter_value isp_mm_bridge.m0/isp_ccm.av_mm_control_agent                 baseAddress "0x00000000"
...
proc add_auto_connections {} {
    ...
    # to vid out
    add_auto_connection   ${v_instance_name} isp_lite_out_m_vid       isp_lite_out_vid
