...
void intel_fpga_i2c_write(long i2c_base, unsigned char address, unsigned int reg,
                                   unsigned char data) {
...
unsigned char intel_fpga_i2c_read(long i2c_base, unsigned char address, unsigned int reg) {
